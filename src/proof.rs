...
pub struct PkeyT<E: Engine> {
    pub pkey: ProvingKey<<E as Engine>::G1Affine>,
}

impl<E: Engine> PkeyT<E> {
    // Constructor function
    pub fn new(pkey: ProvingKey<<E as Engine>::G1Affine>) -> Self {
        PkeyT { pkey }
    }
}
