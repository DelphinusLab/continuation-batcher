...
CUDA_VISIBLE_DEVICES=3 RUST_BACKTRACE=1 cargo run --features perf --release -- --params $WKDIR/params --output $WKDIR/output round_1_batch -k 23 --target-k 22 --name fib_agg 