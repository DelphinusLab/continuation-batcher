...
# batch test proofs
cargo run --release --features cuda -- --param ./params --output ./output batch -k 22 --challenge sha --info output/test2.loadinfo.json output/test1.loadinfo.json --name batchsample --commits sample/batchinfo1.json --cont
